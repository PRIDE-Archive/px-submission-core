...
public class MetadataIndexedLineItemProcessingStrategiesParsingStackTest {
    ...
    public static Collection<Object[]> subjectsToTest() {
        return Arrays.asList(new Object[][]{
                ...
                {"MTD", "ms_run", 113, "location", "null", "ms_run location with null value", new QuickMzTabMsRunLocationLineItemParsingHandler()},
                {"MTD", "ms_run", 114, "hash", "de9f2c7fd25e1b3afad3e85a0bd17d9b100db4b3", "ms_run hash", new QuickMzTabMsRunHashLineItemParsingHandler()},
                {"MTD", "ms_run", 115, "hash_method", "[MS, MS: MS:1000569, SHA-1, ]", "ms_run hash_method", new QuickMzTabMsRunHashMethodLineItemParsingHandler()},
                ...
                {"MTD", "sample", 1300, "description", "this is a sample description", "collection of sample description", new QuickMzTabSampleDescriptionLineItemParsingHandler()},
